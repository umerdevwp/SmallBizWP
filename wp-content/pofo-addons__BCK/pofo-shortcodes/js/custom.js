!function($) {
  ...
  $( document ).ready(function() {
    ...
    /* For New Instagram Token */
      $( document ).on( 'click', '.enable_new_token', function() {
        if($(this).prop("checked") == true) {
            $(this).parents( '.widget-content' ).find( '.show-new-instagram' ).addClass( 'active' );
            $(this).parents( '.widget-content' ).find( '.hide-new-instagram' ).addClass( 'deactive' );
        } else if($(this).prop("checked") == false) {
            $(this).parents( '.widget-content' ).find( '.show-new-instagram' ).removeClass( 'active' );
            $(this).parents( '.widget-content' ).find( '.hide-new-instagram' ).removeClass( 'deactive' );
        }        
    });
