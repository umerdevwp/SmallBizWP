<?php
/*
Plugin Name: SmallBiz Addons
Plugin URI: https://smallbiz.com/
Description: A part of SmallBiz theme
Version: 1.2.2
Author: SmallBiz Team
Author URI: http://www.smallbiz.com
Text Domain: smallbiz-addons
*/
?>
<?php
...
defined( 'POFO_ADDONS_ROOT_DIR' ) or define( 'POFO_ADDONS_ROOT_DIR', plugins_url() . '/smallbiz-addons' );
defined( 'POFO_ADDONS_IMPORTER_SAMPLE_DATA_URI' ) or define( 'POFO_ADDONS_IMPORTER_SAMPLE_DATA_URI', plugins_url() . '/smallbiz-addons/importer/sample-data' );
    ...
    class Pofo_Addons {
        ...
        public function pofo_addons_add_customizer_sections( $wp_customize ) {
            ...
            $wp_customize->add_control( new WP_Customize_Code_Editor_Control( $wp_customize, 'custom_html', array(
                ...
                'description' => esc_attr__( 'Only accepts javascript code, wrapped with <script> tags and valid HTML markup inside the </body> tag.', 'pofo-addons' )
            ) ) );
