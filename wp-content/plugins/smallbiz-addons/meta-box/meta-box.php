		...
		public function pofo_add_meta_boxs( $pofo_post_type ) {
	        ...
	        if( $flag == true ) {
	        	switch( $pofo_post_type ) {
	        		case 'post':
	        			$this->pofo_add_meta_box( 'pofo_admin_options', __( 'SmallBiz Post Settings', 'pofo-addons' ), $pofo_post_type );
	        		break;
	        		case 'portfolio':
	        			$this->pofo_add_meta_box( 'pofo_admin_options', __( 'SmallBiz Portfolio Settings', 'pofo-addons' ), $pofo_post_type );
	        		break;
	        		case 'product':
			        	/* if WooCommerce plugin is activated */
						if( class_exists( 'WooCommerce' ) ) {
							$this->pofo_add_meta_box( 'pofo_admin_options', __( 'SmallBiz Product Settings', 'pofo-addons' ), $pofo_post_type );
						}
	        		break;
	        		case 'page':
	        			$this->pofo_add_meta_box( 'pofo_admin_options', __( 'SmallBiz Page Settings', 'pofo-addons' ), $pofo_post_type );
	        		break;
	        	}
		    }
		}
