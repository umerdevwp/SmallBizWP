			        ...
			        echo '<div class="licence-content-top">';
                        echo '<div class="header-licence-top">';
                            ...
                            echo '<div class="header-licence-top-right">';
                                echo '<h4>'.esc_html__( 'Welcome to SmallBiz - Personal Creative & Blog WordPress Theme ', 'pofo' ).'</h4>';
                            echo '</div>';
                        echo '</div>';
                        $class = '';
                        echo '<div class="licence-content-bottom">';    
                            echo '<div class="licence-thankyou-message 	licence-added-success">';
                                echo esc_html__( 'Welcome to SmallBiz WordPress theme. Please activate your SmallBiz theme license copy and enjoy premium features.','pofo' );
                            echo '</div>';
                            $pofo_is_theme_licence_active = pofo_is_theme_licence_active();	

                            if( $pofo_is_theme_licence_active ) {
                                echo '<div class="licence-activated-success"><i class="fas fa-check-circle"></i><span>'.esc_html__( 'Awesome! Your SmallBiz WordPress theme license is activated already. Enjoy premium features of Pofo.', 'pofo' ).'</span></div>';
