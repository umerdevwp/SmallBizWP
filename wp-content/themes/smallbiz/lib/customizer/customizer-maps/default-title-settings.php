<?php
    ...
    $wp_customize->add_setting( 'pofo_default_post_title_default', array(
		'default' 			=> 'Blog',
		'sanitize_callback' => 'esc_attr'
	) );

	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'pofo_default_post_title_default', array(
		'label'       		=> esc_attr__( 'Blog Title', 'pofo' ),
		'section'     		=> 'pofo_add_default_title_section',
		'settings'			=> 'pofo_default_post_title_default',
		'type'              => 'text',
	) ) );
	...
	$wp_customize->add_control( new Pofo_Customize_Preview_Image_Control( $wp_customize, 'pofo_default_title_style', array(
  	...
  	/* Start Disable Default Title Heading */

    $wp_customize->add_setting( 'pofo_enable_default_title_heading', array(
		'default' 			=> '1',
		'sanitize_callback' => 'esc_attr'
	) );

	$wp_customize->add_control( new Pofo_Customize_switch_Control( $wp_customize, 'pofo_enable_default_title_heading', array(
		'label'       		=> esc_attr__( 'Title Heading', 'pofo' ),
		'section'     		=> 'pofo_add_default_title_section',
		'settings'			=> 'pofo_enable_default_title_heading',
		'type'              => 'pofo_switch',
		'choices'           => array(
									'1' => esc_html__( 'On', 'pofo' ),
								  	'0' => esc_html__( 'Off', 'pofo' ),
	...
	/* End Disable Default Title Heading */

  	/* Start Disable Default Title Animation */

    $wp_customize->add_setting( 'pofo_disable_default_title_animation', array(
		'default' 			=> '1',
		'sanitize_callback' => 'esc_attr'
	) );

	$wp_customize->add_control( new Pofo_Customize_switch_Control( $wp_customize, 'pofo_disable_default_title_animation', array(
		'label'       		=> esc_attr__( 'Title Animation', 'pofo' ),
		'section'     		=> 'pofo_add_default_title_section',
		'settings'			=> 'pofo_disable_default_title_animation',
		'type'              => 'pofo_switch',
		'choices'           => array(
									'1' => esc_html__( 'On', 'pofo' ),
								  	'0' => esc_html__( 'Off', 'pofo' ),
	...
	/* End Disable Default Title Animation */

	/* Start Disable Default Title Animation style */
    
    $wp_customize->add_setting( 'pofo_default_title_animation', array(
		'default' 			=> 'fadeIn',
		'sanitize_callback' => 'esc_attr'
	) );

	$wp_customize->add_control( new Pofo_Customize_Animation_Control( $wp_customize, 'pofo_default_title_animation', array(
		'label'				=> __( 'Animation', 'pofo' ),
		'type'              => 'pofo_animation_style',
		'section'     		=> 'pofo_add_default_title_section',
		'settings'			=> 'pofo_default_title_animation',
		'active_callback'	=> 'pofo_default_title_animation_callback'
	) ) );

	/* End Disable Default Title Animation style */
	...
	$wp_customize->add_control( new Pofo_Alpha_Color_Control( $wp_customize, 'pofo_default_title_opacity_color', array(
    ...
    $wp_customize->add_setting( 'pofo_default_enable_breadcrumb_heading', array(
		'default' 			=> '1',
		'sanitize_callback' => 'esc_attr'
	) );

	$wp_customize->add_control( new Pofo_Customize_switch_Control( $wp_customize, 'pofo_default_enable_breadcrumb_heading', array(
		'label'       		=> esc_attr__( 'Breadcrumb Heading', 'pofo' ),
		'section'     		=> 'pofo_add_default_title_section',
		'settings'			=> 'pofo_default_enable_breadcrumb_heading',
		'type'              => 'pofo_switch',
		'choices'           => array(
									'1' => esc_html__( 'On', 'pofo' ),
								  	'0' => esc_html__( 'Off', 'pofo' ),
    ...
    $wp_customize->add_setting( 'pofo_disable_default_breadcrumb_animation', array(
		'default' 			=> '1',
		'sanitize_callback' => 'esc_attr'
	) );

	$wp_customize->add_control( new Pofo_Customize_switch_Control( $wp_customize, 'pofo_disable_default_breadcrumb_animation', array(
		'label'       		=> esc_attr__( 'Breadcrumb animation', 'pofo' ),
		'section'     		=> 'pofo_add_default_title_section',
		'settings'			=> 'pofo_disable_default_breadcrumb_animation',
		'type'              => 'pofo_switch',
		'choices'           => array(
									'1' => esc_html__( 'On', 'pofo' ),
								  	'0' => esc_html__( 'Off', 'pofo' ),
    ...
    $wp_customize->add_setting( 'pofo_default_breadcrumb_animation', array(
		'default' 			=> 'fadeIn',
		'sanitize_callback' => 'esc_attr'
	) );

	$wp_customize->add_control( new Pofo_Customize_Animation_Control( $wp_customize, 'pofo_default_breadcrumb_animation', array(
		'label'				=> __( 'Animation', 'pofo' ),
		'type'              => 'pofo_animation_style',
		'section'     		=> 'pofo_add_default_title_section',
		'settings'			=> 'pofo_default_breadcrumb_animation',
		'active_callback'   => 'pofo_default_breadcrumb_animation_callback'	
	) ) );
    ...
    $wp_customize->add_setting( 'pofo_default_title_breadcrumb_position', array(
		'default' 			=> '',
		'sanitize_callback' => 'esc_attr'
	) );

	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'pofo_default_title_breadcrumb_position', array(
		'label'       		=> esc_attr__( 'Breadcrumb Position', 'pofo' ),
		'section'     		=> 'pofo_add_default_title_section',
		'settings'			=> 'pofo_default_title_breadcrumb_position',
		'type'              => 'select',
		'active_callback' 	=> 'pofo_default_title_breadcrumb_callback',
		'choices'           => array(
    ...
    $wp_customize->add_setting( 'pofo_default_title_breadcrumb_alignment', array(
		'default' 			=> '',
		'sanitize_callback' => 'esc_attr'
	) );

	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'pofo_default_title_breadcrumb_alignment', array(
		'label'       		=> esc_attr__( 'Breadcrumb Alignment', 'pofo' ),
		'section'     		=> 'pofo_add_default_title_section',
		'settings'			=> 'pofo_default_title_breadcrumb_alignment',
		'type'              => 'select',
		'active_callback' 	=> 'pofo_default_title_breadcrumb_position_callback',
		'choices'           => array(
									''		=> esc_html__( 'Select', 'pofo' ),
    ...
    $wp_customize->add_setting( 'pofo_default_title_top_space', array(
		'default' 			=> '',
		'sanitize_callback' => 'esc_attr'
	) );

	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'pofo_default_title_top_space', array(
		'label'       		=> esc_attr__( 'Add Margin Top of Header Height', 'pofo' ),
		'section'     		=> 'pofo_add_default_title_section',
		'settings'			=> 'pofo_default_title_top_space',
		'type'              => 'select',
		'choices'           => array(
	...
	$wp_customize->add_setting( 'pofo_default_title_content_height', array(
		'default' 			=> '',
		'sanitize_callback' => 'esc_attr'
    ) );

	$wp_customize->add_control( 'pofo_default_title_content_height', array(
	    'label'      		=> esc_attr__( 'Content Height', 'pofo' ),
	    'section'    		=> 'pofo_add_default_title_section',
	    'settings'	 		=> 'pofo_default_title_content_height',
	    'type'       		=> 'text',
	    'active_callback' 	=> 'pofo_default_title_image_opacity_callback',
	) );
	...
	$wp_customize->add_control( new Pofo_Alpha_Color_Control( $wp_customize, 'pofo_default_title_bg_color', array(
	...
	$wp_customize->add_control( new Pofo_Alpha_Color_Control( $wp_customize, 'pofo_default_title_color', array(
	...
	$wp_customize->add_control( new Pofo_Alpha_Color_Control( $wp_customize, 'pofo_default_subtitle_color', array(
    ...
    $wp_customize->add_control( new Pofo_Alpha_Color_Control( $wp_customize, 'pofo_default_title_breadcrumb_bg_color', array(
    ...
    $wp_customize->add_control( new Pofo_Alpha_Color_Control( $wp_customize, 'pofo_default_title_breadcrumb_border_color', array(
	...
	$wp_customize->add_control( new Pofo_Alpha_Color_Control( $wp_customize, 'pofo_default_title_breadcrumb_color', array(
	...
	$wp_customize->add_control( new Pofo_Alpha_Color_Control( $wp_customize, 'pofo_default_title_breadcrumb_text_hover_color', array(
	...
	$wp_customize->add_control( new Pofo_Alpha_Color_Control( $wp_customize, 'pofo_default_title_icon_bg_color', array(
	...
	$wp_customize->add_control( new Pofo_Alpha_Color_Control( $wp_customize, 'pofo_default_title_icon_color', array(
	...
	if ( ! function_exists( 'pofo_default_breadcrumb_animation_callback' ) ) :
		function pofo_default_breadcrumb_animation_callback( $control ){
			if ( $control->manager->get_setting( 'pofo_default_disable_breadcrumb' )->value() == '1' && $control->manager->get_setting( 'pofo_disable_default_breadcrumb_animation' )->value() == '1' ) {
		        return true;
		    } else {
		    	return false;
		    }
	...
	if( ! function_exists( 'pofo_default_title_breadcrumb_position_callback' ) ) :
		function pofo_default_title_breadcrumb_position_callback( $control ){
			if ( $control->manager->get_setting( 'pofo_default_title_breadcrumb_position' )->value() == 'after-title-area' && $control->manager->get_setting( 'pofo_default_disable_breadcrumb' )->value() == '1') {
		        return true;
		    } else {
		    	return false;
		    }
	...
	if ( ! function_exists( 'pofo_default_title_animation_callback' ) ) :
		function pofo_default_title_animation_callback( $control ){
			if ( $control->manager->get_setting( 'pofo_disable_default_title_animation' )->value() == '1' ) {
		        return true;
		    } else {
		    	return false;
		    }
