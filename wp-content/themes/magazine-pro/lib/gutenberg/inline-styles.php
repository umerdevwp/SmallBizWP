...
function magazine_custom_gutenberg_admin_css() {
	...
	$css = <<<CSS
.ab-block-post-grid .ab-text-link.ab-block-post-grid-more-link:hover,
...
.editor-styles-wrapper .button-more-link.ab-block-post-grid .ab-text-link.ab-block-post-grid-more-link:hover,
...
.editor-styles-wrapper .ab-block-post-grid .is-grid .ab-block-post-grid-date {
	background-color: {$appearance['button-background']};
	color: {$appearance['button-text-color']};
}
