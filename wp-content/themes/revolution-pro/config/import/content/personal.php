 ...
 * Revolution Pro.
 *
 * Personal content optionally installed after theme activation.
 *
...
$revolution_personal_header_image_url = CHILD_URL . '/config/import/images/personal.jpg';

$revolution_personal_ebook_image_url = CHILD_URL . '/config/import/images/ebook-cover.jpg';
...
$revolution_personal_content = <<<CONTENT
<!-- wp:image {"id":1935,"align":"full"} -->
<figure class="wp-block-image alignfull"><img src="$revolution_personal_header_image_url" alt="" class="wp-image-1935"/></figure>
<!-- /wp:image -->

<!-- wp:atomic-blocks/ab-container {"containerPaddingTop":8.5,"containerPaddingBottom":10,"containerMarginTop":-25,"containerMaxWidth":800,"className":"boxshadow wide-featured rev-overlap"} -->
<div style="background-color:#fff;padding-left:0%;padding-right:0%;padding-bottom:10%;padding-top:8.5%;margin-top:-25%;margin-bottom:0%" class="wp-block-atomic-blocks-ab-container boxshadow wide-featured rev-overlap aligncenter ab-block-container"><div class="ab-container-inside"><div class="ab-container-content" style="max-width:800px"><!-- wp:heading {"level":1,"align":"center"} -->
<h1 style="text-align:center">Hello, I’m Sarah.</h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","fontSize":"large"} -->
<p style="text-align:center" class="has-large-font-size">I am a minimalist designer and create digital wonder.</p>
<!-- /wp:paragraph -->
...
<figure class="wp-block-pullquote alignwide"><blockquote><p>“Sarah is a breath of fresh air and a beautiful soul.”</p><cite>—Jessica Anne Taylor, Client</cite></blockquote></figure>
<!-- /wp:pullquote -->
...
<figure class="wp-block-image"><img src="$revolution_personal_ebook_image_url" alt="" class="wp-image-1873"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
return $revolution_personal_content;
