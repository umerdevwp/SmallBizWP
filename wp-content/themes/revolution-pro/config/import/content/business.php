 ...
 * Revolution Pro.
 *
 * Business content optionally installed after theme activation.
 *
...
$revolution_business_header_image_url = CHILD_URL . '/config/import/images/business.jpg';

$revolution_business_ebook_image_url = CHILD_URL . '/config/import/images/ebook-cover.jpg';
...
$revolution_business_content = <<<CONTENT
<!-- wp:image {"id":1935,"align":"full"} -->
<figure class="wp-block-image alignfull"><img src="$revolution_business_header_image_url" alt="" class="wp-image-1935"/></figure>
<!-- /wp:image -->
...
<h1 style="text-align:center">We rise above.</h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","fontSize":"large"} -->
<p style="text-align:center" class="has-large-font-size">Our company revolutionized the small business market.</p>
<!-- /wp:paragraph -->
...
<figure class="wp-block-image"><img src="$revolution_business_ebook_image_url" alt="" class="wp-image-1873"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
return $revolution_business_content;
