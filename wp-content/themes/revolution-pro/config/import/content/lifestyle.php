 ...
 * Revolution Pro.
 *
 * Lifestyle content optionally installed after theme activation.
 *
...
$revolution_lifestyle_header_image_url = CHILD_URL . '/config/import/images/lifestyle.jpg';

$revolution_lifestyle_ebook_image_url = CHILD_URL . '/config/import/images/ebook-cover.jpg';
...
$revolution_lifestyle_content = <<<CONTENT
<!-- wp:image {"id":1935,"align":"full"} -->
<figure class="wp-block-image alignfull"><img src="$revolution_lifestyle_header_image_url" alt="" class="wp-image-1935"/></figure>
<!-- /wp:image -->
...
<h1 style="text-align:center">The boho life.</h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","fontSize":"large"} -->
<p style="text-align:center" class="has-large-font-size">A blog about bohemian and hippie influences.</p>
<!-- /wp:paragraph -->
...
<figure class="wp-block-pullquote alignwide"><blockquote><p>“Cassandra has a way of capturing the essence of life.” </p><cite>—Makayla Morris, subscriber</cite></blockquote></figure>
<!-- /wp:pullquote -->
...
<figure class="wp-block-image"><img src="$revolution_lifestyle_ebook_image_url" alt="" class="wp-image-1873"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
return $revolution_lifestyle_content;
